 ...
 * PAGE0
 */
#define REG_FCP_ISR1				(0x80 + 0x19)	/* FCP ????1?????? */
#define REG_FCP_ISR2				(0x80 + 0x1A)	/* FCP ????2?????? */
#define REG_FCP_IMR1				(0x80 + 0x1B)	/* FCP ????????1?????? */
#define REG_FCP_IMR2				(0x80 + 0x1C)	/* FCP ????????2?????? */
#define REG_FCP_IRQ5				(0x80 + 0x1D)	/* FCP????5?????? */
#define REG_FCP_IRQ5_MASK			(0x80 + 0x1E)	/* FCP????????5?????? */

#define REG_PD_CDR_CFG_0			(0x80 + 0x58)	/* PD????BMC?????????????????????? */
#define REG_PD_CDR_CFG_1			(0x80 + 0x59)	/* PD????BMC?????????????????????? */
#define REG_PD_DBG_CFG_0			(0x80 + 0x5A)	/* PD????Debug???????????? */
#define REG_PD_DBG_CFG_1			(0x80 + 0x5B)	/* PD????Debug???????????? */
#define REG_PD_DBG_RO_0				(0x80 + 0x5C)	/* PD????Debug???????????? */
#define REG_PD_DBG_RO_1				(0x80 + 0x5D)	/* PD????Debug???????????? */
#define REG_PD_DBG_RO_2				(0x80 + 0x5E)	/* PD????Debug???????????? */
#define REG_PD_DBG_RO_3				(0x80 + 0x5F)	/* PD????Debug???????????? */

#define REG_IRQ_FAKE_SEL			(0x80 + 0x60)	/* ???????????????????????? */
#define REG_IRQ_FAKE				(0x80 + 0x61)	/* ???????? */
...
#define REG_WDT_SOFT_RST			(0x80 + 0x6B)	/* ?????????????????????? */
#define REG_WDT_CTRL				(0x80 + 0x6C)	/* ?????????????????? */
 ...
 * PAGE1
 */
#define REG_FCP_IRQ3				(0x180 + 0x00)	/* FCP????3?????? */
#define REG_FCP_IRQ4				(0x180 + 0x01)	/* FCP????4?????? */
#define REG_FCP_IRQ3_MASK			(0x180 + 0x02)	/* FCP????????3?????? */
#define REG_FCP_IRQ4_MASK			(0x180 + 0x03)	/* FCP????????4?????? */



#define REG_IRQ_MASK		(0x180 + 0x48)
# define BIT_IRQ_MASK_GLB	(1 << 7) /* bit[7]????????????????????????????????????????????1: ???????????????? 0???????????????????? */
# define BIT_IRQ_MASK_SRC	(1 << 6) /* bit[6]??????????????????????????????????????????????1???????????????????????? 0?????????????????????????????????????? */
# define BIT_IRQ_MASK_BUCK	(1 << 4) /* bit[4]??BUCK????????????1????????????????0????????????????*/
# define BIT_IRQ_MASK_LVC_SC	(1 << 3) /* bit[3]??LVC_SC???????????? 1????????????????0????????????????*/
# define BIT_IRQ_MASK_PD	(1 << 2) /* bit[2]??PD?????????? 1: ???????????? 0????????????????*/
# define BIT_IRQ_MASK_OTHERS	(1 << 1) /* bit[1]??Others?????????????? 1: ???????????? 0????????????????*/
# define BIT_IRQ_MASK_FCP	(1 << 0) /* bit[0]??FCP?????????????? 1: ???????????? 0????????????????*/
 ...
 * PAGE2
 */
#define REG_TCPC_CFG_REG_1			(0x280 + 0x0E)	/* TCPC_??????????_1 */
#define REG_TCPC_CFG_REG_2			(0x280 + 0x0F)	/* TCPC_??????????_2 */
#define REG_TCPC_CFG_REG_3			(0x280 + 0x10)	/* TCPC_??????????_3 */
#define REG_TCPC_RO_REG_5			(0x280 + 0x11)	/* TCPC_??????????_5 */
...
#define REG_BUCK_CFG_REG_3		(0x280 + 0x53)		/* BUCK_??????????_3 */
#define REG_BUCK_CFG_REG_4		(0x280 + 0x54)            /* BUCK_??????????_4 */
#define REG_BUCK_CFG_REG_5		(0x280 + 0x55)            /* BUCK_??????????_5 */
#define REG_BUCK_CFG_REG_6		(0x280 + 0x56)            /* BUCK_??????????_6 */
#define REG_BUCK_CFG_REG_7		(0x280 + 0x57)            /* BUCK_??????????_7 */
#define REG_BUCK_CFG_REG_8		(0x280 + 0x58)            /* BUCK_??????????_8 */
#define REG_BUCK_CFG_REG_9		(0x280 + 0x59)            /* BUCK_??????????_9 */
#define REG_BUCK_CFG_REG_10		(0x280 + 0x5A)            /* BUCK_??????????_10 */
#define REG_BUCK_CFG_REG_11		(0x280 + 0x5B)            /* BUCK_??????????_11 */
#define REG_BUCK_CFG_REG_12		(0x280 + 0x5C)            /* BUCK_??????????_12 */
#define REG_BUCK_CFG_REG_13		(0x280 + 0x5D)            /* BUCK_??????????_13 */
#define REG_BUCK_CFG_REG_14		(0x280 + 0x5E)            /* BUCK_??????????_14 */
#define REG_BUCK_CFG_REG_15		(0x280 + 0x5F)            /* BUCK_??????????_15 */
#define REG_BUCK_CFG_REG_16		(0x280 + 0x60)            /* BUCK_??????????_16 */
#define REG_BUCK_CFG_REG_17		(0x280 + 0x61)            /* BUCK_??????????_17 */
#define REG_BUCK_CFG_REG_18		(0x280 + 0x62)            /* BUCK_??????????_18 */
#define REG_BUCK_CFG_REG_19		(0x280 + 0x63)            /* BUCK_??????????_19 */
#define REG_BUCK_CFG_REG_20		(0x280 + 0x64)            /* BUCK_??????????_20 */
#define REG_BUCK_CFG_REG_21		(0x280 + 0x65)            /* BUCK_??????????_21 */
#define REG_BUCK_CFG_REG_22		(0x280 + 0x66)            /* BUCK_??????????_22 */
#define REG_BUCK_CFG_REG_23		(0x280 + 0x67)            /* BUCK_??????????_23 */
#define REG_BUCK_CFG_REG_24		(0x280 + 0x68)            /* BUCK_??????????_24 */
#define REG_BUCK_CFG_REG_25		(0x280 + 0x69)            /* BUCK_??????????_25 */
#define REG_BUCK_RO_REG_26		(0x280 + 0x6A)            /* BUCK_??????????_26 */
#define REG_BUCK_RO_REG_27		(0x280 + 0x6B)            /* BUCK_??????????_27 */
#define REG_BUCK_RO_REG_28		(0x280 + 0x6C)            /* BUCK_??????????_28 */

#define REG_OTG_CFG_REG_0			(0x280 + 0x6D)	/* OTG_??????????_0 */
#define REG_OTG_CFG_REG_1			(0x280 + 0x6E)    /* OTG_??????????_1 */
#define REG_OTG_CFG_REG_2			(0x280 + 0x6F)    /* OTG_??????????_2 */
#define REG_OTG_CFG_REG_3			(0x280 + 0x70)    /* OTG_??????????_3 */
#define REG_OTG_CFG_REG_4			(0x280 + 0x71)    /* OTG_??????????_4 */
#define REG_OTG_CFG_REG_5			(0x280 + 0x72)    /* OTG_??????????_5 */
#define REG_OTG_CFG_REG_6			(0x280 + 0x73)    /* OTG_??????????_6 */
...
#define REG_OTG_RO_REG_7			(0x280 + 0x74)    /* OTG_??????????_7 */
#define REG_OTG_RO_REG_8			(0x280 + 0x75)    /* OTG_??????????_8 */
#define REG_OTG_RO_REG_9			(0x280 + 0x76)    /* OTG_??????????_9 */
